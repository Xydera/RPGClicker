...
const handleRespec = () => {
  ...
  return (
    <div id="gameContainer" style={{ padding: "1rem", color: "#fff", display: "flex", flexDirection: "column", gap: "0.5rem" }}>
      <div id="topSection">
        <div className="left">
          <PlayerInfo player={player} game={game} onToggleStats={() => setMenuState(s => ({ ...s, stats: !s.stats }))} onEditStateChange={setIsEditingName} />
        </div>
        <div className="center">
          <CreatureDisplay player={player} creature={creature} onClickAttack={handleAttack} />
        </div>
        <div className="right">
          <EquippedWeapon sword={sword} player={player} />
        </div>
      </div>
